...
class _singlerequestState extends State<singlerequest> {
  ...
  Widget build(BuildContext context) {
    final requestobject=WorkRequests(Contractor: widget.requestdetails['Contractor'],Reciever: widget.requestdetails['Reciever']);
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 10.0,),
                                          Text(widget.requestdetails['Name'],style: TextStyle(fontSize: 20.0),),
                                          SizedBox(height: 10.0,),
                                          ...
                                          SizedBox(height: 10.0,),
                                          (widget.requestdetails['accepted'])? (widget.requestdetails['completed']?Container():
                                          Row(children: [
                                            Expanded(child: ElevatedButton(
                                                onPressed: (){
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) =>locationfind(locationdetails: widget.requestdetails,)),
                                                  );
                                                },
                                            ...
                                            children: [
                                              Row(children: [
                                                Expanded(child: ElevatedButton.icon(
                                                  onPressed: ()async{
                                                    await requestobject.acceptrequest(widget.requestdetails);
                                                    Navigator.pop(context);
                                                  },
                                              ...
                                              Row(children: [
                                                Expanded(child: ElevatedButton.icon(
                                                    onPressed: ()async{
                                                      await requestobject.deleterecord(widget.requestdetails);
                                                      Navigator.pop(context);
                                                    },
                                                    icon: Icon(Icons.clear),
                                                  label: Text("Reject"),
                                                    style: ButtonStyle(
                                                        backgroundColor: MaterialStateProperty.all(Colors.redAccent[500])
                                                    )
